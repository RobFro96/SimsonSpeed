...
static sprite_t label_kmh = { 14, 3, 17, { 0x7a, 0x22, 0x52, 0x2, 0x62, 0x12,
		0x72, 0x12, 0x72, 0x2, 0x42, 0x32, 0xa, 0x2, 0x7a, 0x12, 0x62 } };//!< KM/H-Label, siehe gfx/label_kmh.png

static sprite_t label_km = { 60, 3, 9, { 0x7a, 0x22, 0x52, 0x2, 0x62, 0x12,
		0x72, 0x12, 0x72 } };	//!< KM-Label, siehe gfx/label_km.png

static sprite_t label_gang = { 85, 3, 16, { 0x32, 0x4a, 0x6a, 0x2, 0x62, 0x52,
		0x72, 0x42, 0x2, 0x62, 0x12, 0x72, 0x2, 0x12, 0xaa, 0x7a } };//!< Gang-Label, siehe gfx/label_gang.png

static sprite_t label_rpm = { 84, 2, 18, { 0xa, 0x4, 0xa, 0x80, 0x42, 0x2f, 0x0,
		0xc6, 0x29, 0xe6, 0x20, 0xe6, 0x9, 0xa6, 0x0, 0xc6, 0x29, 0xe6 } };	//!< RPM-Label, siehe gfx/label_rpm.png

static sprite_t label_trip1 =
		{ 47, 4, 6, { 0x66, 0x7f, 0x7f, 0x60, 0x0, 0x28 } };//!< Trip1-Label, siehe gfx/label_trip1.png
static sprite_t label_trip2 =
		{ 47, 5, 6, { 0x66, 0x73, 0x7f, 0x6e, 0x0, 0x28 } };//!< Trip2-Label, siehe gfx/label_trip2.png
static sprite_t label_trip_total = { 47, 6, 5, { 0x3, 0x7f, 0x7f, 0x3, 0x28 } };//!< Trip1-Gesamt-Label, siehe gfx/label_trip_total.png
...
void fixed_draw() {
	...
	sprite_draw(&label_rpm);
	sprite_draw(&label_kmh);
	sprite_draw(&label_km);
	sprite_draw(&label_gang);

	sprite_draw(&label_trip1);
	sprite_draw(&label_trip2);
	sprite_draw(&label_trip_total);
}
